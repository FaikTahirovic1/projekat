...
public class DriverDriverTest {
    ...
    void add() throws F1Exception {
        ...
        F1Exception f1Exception = Assertions.assertThrows(F1Exception.class, () -> {
            driverManager.add(driver);}, "Can't add category with ID. ID is autogenerated");

        Assertions.assertEquals("Can't add category with ID. ID is autogenerated", f1Exception.getMessage());
